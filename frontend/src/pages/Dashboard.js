          ...
          <div className="space-y-3">
            {recentTasks.map((task, index) => (
              <motion.div
                ...
                className="bg-white border border-zinc-200 rounded-xl sm:rounded-2xl p-3 sm:p-4 hover:shadow-sm hover:-translate-y-1 transition-all duration-200"
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1 min-w-0">
                    <h3 className="font-plex text-sm sm:text-base text-zinc-900 font-medium truncate">{task.title}</h3>
