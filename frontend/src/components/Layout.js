...
import { LayoutDashboard, CheckSquare, FileText, Megaphone, LogOut } from 'lucide-react';
...
export default function Layout({ children, user, onLogout }) {
  ...
  return (
    <div className="flex min-h-screen bg-white">
      {/* Sidebar */}
      <aside className="w-64 bg-zinc-50 border-r border-zinc-200 flex flex-col fixed h-full">
        ...
        <div className="p-4 border-t border-zinc-200">
          <div className="bg-white rounded-xl p-4 border border-zinc-200 mb-3">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 rounded-full bg-zinc-900 text-white flex items-center justify-center font-plex font-medium">
